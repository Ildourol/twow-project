...
| --- | --- | --- |
| Target | `tortoise-wow-extended` | `bb5c085a68d894dff540962fe53359e5e999c95f` |
| IKE3 vMaNGOS donor | `reference-upstreams/core` | `e40e641e66fae87a0e75dba7e0ea2fd5707cef91` |
| CMaNGOS donor | `reference-upstreams/playerbots` | `89a4e5aebd6aa41ee87f6e65d89b66fff5c5c7c1` |
...
Bot-specific evidence: `modules/mod-playerbots/cmangos-compat-shim.h`, `botpch.h`, `mod-playerbots.cmake`, `src/playerbot/strategy/Action.h`, `src/playerbot/PlayerbotMgr.cpp`, plus target `build/CMakeCache.txt`.
