---
name: turtle-playerbots-porting
description: Port CMaNGOS, vMaNGOS IKE3 and AzerothCore bot behavior into this Turtle WoW PlayerBots module while preserving native lifecycle, Classic mechanics and Dungeon Clear.
---

# Turtle PlayerBots porting
...
Read `tortoise-wow-extended/AGENTS.md`, its `docs/CORE_SYSTEMS_GUIDE.md`, and this project's `docs/DUNGEON_CLEAR_COMPATIBILITY.md` for the affected seam. The native module is `modules/mod-playerbots`; donor trees under `reference-upstreams` supply evidence.
...
5. Review Turtle custom-content contracts, action/value registrations, socketless sessions and Dungeon Clear. Do not broaden a fix into a foreign subsystem rewrite.
