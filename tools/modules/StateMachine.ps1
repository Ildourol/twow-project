...
$script:ALLOWED_TRANSITIONS = @{
    "DISCOVERED" = @("TRIAGED", "BUG_PROOF_PENDING", "BUG_PRESENT", "ALREADY_FIXED", "NOT_APPLICABLE", "TURTLE_INTENTIONAL_DIVERGENCE", "PATCH_READY", "REJECTED")
    ...
    "PATCH_READY" = @("COMPILE_PENDING", "COMPILE_PASS", "COMPILE_FAIL", "COMPLETE", "NEEDS_REAUDIT", "REJECTED")
