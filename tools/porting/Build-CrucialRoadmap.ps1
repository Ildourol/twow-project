...
[void]$sb.AppendLine('* **Command**: `task 1`')
[void]$sb.AppendLine('* **Role**: Single-writer MSVC 2022 Release compile gate (0 errors required), atomic git commit, and immediate push to `extended main`.')
[void]$sb.AppendLine('')
