...
| **UPSTREAM (CMaNGOS PlayerBots)** | `playerbots` | `https://github.com/cmangos/playerbots.git` | `master` | `89a4e5aebd6aa41ee87f6e65d89b66fff5c5c7c1` | Standalone CMaNGOS PlayerBots module. High-velocity development. |
| **UPSTREAM (vMaNGOS PlayerBots Core)** | `core` | `https://github.com/ileboii/core.git` | `vmangos-ike3-playerbots` | `2ff8489f74b82617591f9ada3bab2772bf849da2` | vMaNGOS core fork with ike3 PlayerBots integrated under `src/game/PlayerBots`. |
